...
static const unsigned long __export_PS4_GetAppInfoHook_offset = 0x4bc;
static const unsigned long __export_PS5_GetAppInfoHook_offset = 0x59d;
static const unsigned long __export_PS5_GetAppInfoHook2_offset = 0x625;
...
static const unsigned char shellcode[] = {
    ...
    0xbe, 0xff, 0xff, 0xff, 0xff,                                                                    // mov	esi, -1
                                                                                                     // L_BB0_3:
    0x48, 0x8d, 0x3d, 0x44, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str]
    ...
    0x48, 0x8d, 0x3d, 0x46, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.1]
    ...
    0xe8, 0xaf, 0x07, 0x00, 0x00,                                                                    // call	_ZL15ignore_procnamei
    0x89, 0xc1,                                                                                      // mov	ecx, eax
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0x84, 0xc9,                                                                                      // test	cl, cl
    0x0f, 0x85, 0x4b, 0x02, 0x00, 0x00,                                                              // jne	L_BB1_18
    ...
    0x48, 0x8d, 0x3d, 0x81, 0x0c, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.14]
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0x41, 0x57,                                                                                      // push	r15
    0x53,                                                                                            // push	rbx
    0x41, 0x53,                                                                                      // push	r11
    ...
    0x41, 0x55,                                                                                      // push	r13
    0x41, 0x52,                                                                                      // push	r10
    0xe8, 0x88, 0xfd, 0xff, 0xff,                                                                    // call	printf
    ...
    0xe8, 0x5b, 0xfd, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x8b, 0x7b, 0x48,                                                                                // mov	edi, dword ptr [rbx + 72]
    0x48, 0x8d, 0xb5, 0x30, 0xff, 0xff, 0xff,                                                        // lea	rsi, [rbp - 208]
    0xe8, 0x98, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x84, 0x1d, 0xff, 0xff, 0xff,                                                              // je	L_BB1_11
    0x48, 0x8d, 0x3d, 0xd3, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.13]
    0x89, 0xc6,                                                                                      // mov	esi, eax
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x04, 0xfd, 0xff, 0xff,                                                                    // call	printf
    0xe9, 0x08, 0xff, 0xff, 0xff,                                                                    // jmp	L_BB1_11
                                                                                                     // L_BB1_12:
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x44, 0x8b, 0x6d, 0xcc,                                                                          // mov	r13d, dword ptr [rbp - 52]
    0x0f, 0x8e, 0x98, 0x00, 0x00, 0x00,                                                              // jle	L_BB1_17
    0x48, 0x8d, 0x9d, 0x30, 0xff, 0xff, 0xff,                                                        // lea	rbx, [rbp - 208]
    ...
    0x0f, 0x29, 0x85, 0x30, 0xff, 0xff, 0xff,                                                        // movaps	xmmword ptr [rbp - 208], xmm0
    0x48, 0xc7, 0x45, 0x80, 0x00, 0x00, 0x00, 0x00,                                                  // mov	qword ptr [rbp - 128], 0
    0x4d, 0x63, 0x27,                                                                                // movsxd	r12, dword ptr [r15]
    0x44, 0x89, 0xef,                                                                                // mov	edi, r13d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0xe8, 0x28, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x49, 0x8d, 0xbf, 0xbf, 0x01, 0x00, 0x00,                                                        // lea	rdi, [r15 + 447]
    0xe8, 0x8c, 0x06, 0x00, 0x00,                                                                    // call	_Z8stringidPKc
    0x3d, 0xc4, 0xc1, 0xe4, 0xb1,                                                                    // cmp	eax, -1310408252
    0x74, 0x11,                                                                                      // je	L_BB1_16
    0x4d, 0x01, 0xe7,                                                                                // add	r15, r12
    0x48, 0x8b, 0x45, 0xd0,                                                                          // mov	rax, qword ptr [rbp - 48]
    0x4c, 0x01, 0xf0,                                                                                // add	rax, r14
    0x49, 0x39, 0xc7,                                                                                // cmp	r15, rax
    0x72, 0xa2,                                                                                      // jb	L_BB1_15
    0xeb, 0x2e,                                                                                      // jmp	L_BB1_17
                                                                                                     // L_BB1_16:
    0xc7, 0x45, 0x98, 0x00, 0x00, 0x00, 0x00,                                                        // mov	dword ptr [rbp - 104], 0
    0x44, 0x89, 0x6d, 0x90,                                                                          // mov	dword ptr [rbp - 112], r13d
    0x8b, 0x95, 0x30, 0xff, 0xff, 0xff,                                                              // mov	edx, dword ptr [rbp - 208]
    0x89, 0x55, 0x94,                                                                                // mov	dword ptr [rbp - 108], edx
    0x48, 0x8d, 0x3d, 0x95, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.16]
    0x44, 0x89, 0xee,                                                                                // mov	esi, r13d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x63, 0xfc, 0xff, 0xff,                                                                    // call	printf
    ...
    0xe8, 0xc2, 0xfb, 0xff, 0xff,                                                                    // call	free
    0x31, 0xc0,                                                                                      // xor	eax, eax
                                                                                                     // L_BB1_18:
    ...
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xd3, 0xfb, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x0b, 0xfc, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x48, 0x8d, 0x3d, 0xef, 0x0e, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.39]
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    ...
    0x48, 0x8d, 0x15, 0xf1, 0x0e, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.42]
    ...
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xf2, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x2a, 0xfb, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x63, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0xe8, 0x9a, 0xfa, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xcd, 0xf9, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0xe8, 0x7d, 0xfa, 0xff, 0xff,                                                                    // call	strncpy
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0xc8, 0xf9, 0xff, 0xff,                                                                    // call	strlen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x72, 0xf9, 0xff, 0xff,                                                                    // call	printf
    ...
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x71, 0xf9, 0xff, 0xff,                                                                    // call	sceKernelSendNotificationRequest
                                                                                                     // L_BB8_8:
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xbb, 0xf8, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0xe8, 0x92, 0xf8, 0xff, 0xff,                                                                    // call	vsnprintf
    ...
    0x49, 0x89, 0xf6,                                                                                // mov	r14, rsi
    0x49, 0x89, 0xff,                                                                                // mov	r15, rdi
    0xe8, 0x09, 0xf9, 0xff, 0xff,                                                                    // call	__error
    0x8b, 0x38,                                                                                      // mov	edi, dword ptr [rax]
    0xe8, 0x0e, 0xf9, 0xff, 0xff,                                                                    // call	strerror
    ...
    0xe8, 0xca, 0xf7, 0xff, 0xff,                                                                    // call	fopen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xd5, 0xf7, 0xff, 0xff,                                                                    // call	memset
    0x4c, 0x89, 0xef,                                                                                // mov	rdi, r13
    0xe8, 0xf1, 0xf7, 0xff, 0xff,                                                                    // call	strlen
    ...
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0x00, 0xf8, 0xff, 0xff,                                                                    // call	fgets
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0xe8, 0x3c, 0xf7, 0xff, 0xff,                                                                    // call	puts
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    ...
    0xbe, 0x00, 0x04, 0x00, 0x00,                                                                    // mov	esi, 1024
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0xb8, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x4d, 0x89, 0xf7,                                                                                // mov	r15, r14
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x5e, 0xf7, 0xff, 0xff,                                                                    // call	printf
    ...
    0x41, 0xbf, 0x01, 0x00, 0x00, 0x00,                                                              // mov	r15d, 1
                                                                                                     // L_BB11_12:
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0x18, 0xf7, 0xff, 0xff,                                                                    // call	fclose
                                                                                                     // L_BB11_13:
    0x44, 0x89, 0xf8,                                                                                // mov	eax, r15d
    ...
    0xba, 0x20, 0x00, 0x00, 0x00,                                                                    // mov	edx, 32
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0xe8, 0xff, 0xf6, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    ...
    0x75, 0x18,                                                                                      // jne	L_BB13_2
                                                                                                     // L_BB13_3:
    0x48, 0x8d, 0x3d, 0x0a, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.17]
    0x48, 0x8d, 0x75, 0xd0,                                                                          // lea	rsi, [rbp - 48]
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xa5, 0xf6, 0xff, 0xff,                                                                    // call	printf
    0xb0, 0x01,                                                                                      // mov	al, 1
    ...
    0x48, 0x8d, 0x05, 0xf8, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.22]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_1:
    ...
    0x48, 0x8d, 0x05, 0xd2, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.20]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_10:
    ...
    0x48, 0x8d, 0x05, 0xd7, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.24]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_2:
    0x48, 0x8d, 0x05, 0xaa, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.18]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_16:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_14:
    0x48, 0x8d, 0x05, 0xa8, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.21]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_15:
    0x48, 0x8d, 0x05, 0xae, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.23]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_13:
    0x48, 0x8d, 0x05, 0x8c, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.19]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // _Z8stringidPKc:
    0x55,                                                                                            // push	rbp
    ...
    0xbe, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	esi, 1
    0x31, 0xd2,                                                                                      // xor	edx, edx
    0xe8, 0x11, 0xf6, 0xff, 0xff,                                                                    // call	socket
    0x41, 0x89, 0xc6,                                                                                // mov	r14d, eax
    0x85, 0xc0,                                                                                      // test	eax, eax
    ...
    0xbf, 0x02, 0x00, 0x00, 0x00,                                                                    // mov	edi, 2
    0x48, 0x8d, 0x35, 0xa7, 0x06, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.30]
    0x48, 0x8d, 0x55, 0xc4,                                                                          // lea	rdx, [rbp - 60]
    0xe8, 0x28, 0xf6, 0xff, 0xff,                                                                    // call	__inet_pton
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x4c, 0x89, 0xee,                                                                                // mov	rsi, r13
    0xba, 0x10, 0x00, 0x00, 0x00,                                                                    // mov	edx, 16
    0xe8, 0xe8, 0xf5, 0xff, 0xff,                                                                    // call	connect
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x79, 0x63,                                                                                      // jns	L_BB16_4
    0x41, 0x89, 0xc7,                                                                                // mov	r15d, eax
    0x48, 0x8d, 0x3d, 0x88, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.31]
    0xe8, 0x94, 0xf5, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0xc1, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.32]
    0x44, 0x89, 0xfe,                                                                                // mov	esi, r15d
    0x44, 0x89, 0xfa,                                                                                // mov	edx, r15d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x5c, 0xf5, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0x3d, 0xe0, 0x09, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str.52]
    0xe8, 0xf0, 0xf4, 0xff, 0xff,                                                                    // call	puts
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0xb9, 0xf5, 0xff, 0xff,                                                                    // call	close
    0xbf, 0x40, 0x42, 0x0f, 0x00,                                                                    // mov	edi, 1000000
    0xe8, 0xea, 0xf4, 0xff, 0xff,                                                                    // call	usleep
    0x49, 0xff, 0xcc,                                                                                // dec	r12
    0x0f, 0x85, 0x60, 0xff, 0xff, 0xff,                                                              // jne	L_BB16_1
    0x8b, 0x0b,                                                                                      // mov	ecx, dword ptr [rbx]
    0x48, 0x8d, 0x15, 0x4c, 0x07, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.36]
    0xbf, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edi, 1
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0x31, 0xc0,                                                                                      // xor	eax, eax
    ...
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x93, 0xf5, 0xff, 0xff,                                                                    // call	send
    0xc7, 0x43, 0x08, 0x00, 0x00, 0x00, 0x00,                                                        // mov	dword ptr [rbx + 8], 0
    0xba, 0x0c, 0x00, 0x00, 0x00,                                                                    // mov	edx, 12
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x6e, 0xf5, 0xff, 0xff,                                                                    // call	recv
    0x8b, 0x5b, 0x08,                                                                                // mov	ebx, dword ptr [rbx + 8]
    0x48, 0x8d, 0x3d, 0xed, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.34]
    0x89, 0xde,                                                                                      // mov	esi, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xde, 0xf4, 0xff, 0xff,                                                                    // call	printf
    0x83, 0xfb, 0x01,                                                                                // cmp	ebx, 1
    0x75, 0x0c,                                                                                      // jne	L_BB16_6
    0x48, 0x8d, 0x3d, 0x3f, 0x09, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str.51]
    0xe8, 0x6d, 0xf4, 0xff, 0xff,                                                                    // call	puts
                                                                                                     // L_BB16_6:
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0x36, 0xf5, 0xff, 0xff,                                                                    // call	close
                                                                                                     // L_BB16_9:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB16_2:
    0x48, 0x8d, 0x3d, 0x48, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.25]
    0xe8, 0xce, 0xf4, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0x70, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.26]
    0x44, 0x89, 0xf6,                                                                                // mov	esi, r14d
    0x44, 0x89, 0xf2,                                                                                // mov	edx, r14d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x96, 0xf4, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0x3d, 0xf8, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.27]
    0x48, 0x8d, 0x35, 0xf8, 0x04, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.28]
    0x48, 0x8d, 0x15, 0x24, 0x05, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.29]
    ...
    0x8b, 0x05, 0xc7, 0x06, 0x00, 0x00,                                                              // mov	eax, dword ptr [rip + _ZZL30get_firmware_version_from_diskiRjE6cached]
    0x85, 0xc0,                                                                                      // test	eax, eax
    ...
    0xe8, 0xc9, 0xf4, 0xff, 0xff,                                                                    // call	dynlib_get_obj_member
    0x85, 0xc0,                                                                                      // test	eax, eax
    ...
    0x89, 0x05, 0x86, 0x06, 0x00, 0x00,                                                              // mov	dword ptr [rip + _ZZL30get_firmware_version_from_diskiRjE6cached], eax
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB19_2:
    0x48, 0x8d, 0x3d, 0x7a, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.37]
    0x89, 0xc3,                                                                                      // mov	ebx, eax
    0xe8, 0xfb, 0xf3, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0xb8, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.38]
    0x89, 0xde,                                                                                      // mov	esi, ebx
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xc5, 0xf3, 0xff, 0xff,                                                                    // call	printf
