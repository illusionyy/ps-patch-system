...
static const unsigned long __export_PS4_GetAppInfoHook_offset = 0x4c6;
static const unsigned long __export_PS5_GetAppInfoHook_offset = 0x5a7;
static const unsigned long __export_PS5_GetAppInfoHook2_offset = 0x62f;
...
static const unsigned char shellcode[] = {
    ...
    0xbe, 0xff, 0xff, 0xff, 0xff,                                                                    // mov	esi, -1
                                                                                                     // L_BB0_3:
    0x48, 0x8d, 0x3d, 0x4e, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str]
    ...
    0x48, 0x8d, 0x3d, 0x50, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.1]
    ...
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x85, 0x21, 0x02, 0x00, 0x00,                                                              // jne	L_BB1_5
    0x48, 0x8d, 0x3d, 0x13, 0x12, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str]
    0xe8, 0xc3, 0xfd, 0xff, 0xff,                                                                    // call	puts
    0x48, 0x83, 0x7d, 0xd0, 0x00,                                                                    // cmp	qword ptr [rbp - 48], 0
    0x0f, 0x8e, 0xc8, 0x01, 0x00, 0x00,                                                              // jle	L_BB1_17
    ...
    0xe8, 0x0a, 0x07, 0x00, 0x00,                                                                    // call	_ZL12state_abbrevm
    ...
    0x48, 0x8d, 0x3d, 0x99, 0x0c, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.14]
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0x41, 0x57,                                                                                      // push	r15
    0x41, 0x56,                                                                                      // push	r14
    0x41, 0x53,                                                                                      // push	r11
    ...
    0x48, 0x8d, 0x3d, 0xe8, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.13]
    ...
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0xe8, 0x1a, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x49, 0x8d, 0xbc, 0x24, 0xbf, 0x01, 0x00, 0x00,                                                  // lea	rdi, [r12 + 447]
    0xe8, 0x25, 0x06, 0x00, 0x00,                                                                    // call	_Z8stringidPKc
    0x3d, 0xc4, 0xc1, 0xe4, 0xb1,                                                                    // cmp	eax, -1310408252
    0x75, 0x9c,                                                                                      // jne	L_BB1_13
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0x27, 0x06, 0x00, 0x00,                                                                    // call	_ZL15ignore_procnamei
    0x84, 0xc0,                                                                                      // test	al, al
    0x75, 0x90,                                                                                      // jne	L_BB1_13
    ...
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xc9, 0xfb, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x01, 0xfc, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xe8, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x20, 0xfb, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x59, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0xe8, 0x90, 0xfa, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xc3, 0xf9, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0xe8, 0x73, 0xfa, 0xff, 0xff,                                                                    // call	strncpy
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0xbe, 0xf9, 0xff, 0xff,                                                                    // call	strlen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x68, 0xf9, 0xff, 0xff,                                                                    // call	printf
    ...
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x67, 0xf9, 0xff, 0xff,                                                                    // call	sceKernelSendNotificationRequest
                                                                                                     // L_BB8_8:
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xb1, 0xf8, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0xe8, 0x88, 0xf8, 0xff, 0xff,                                                                    // call	vsnprintf
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x4c, 0x89, 0xe2,                                                                                // mov	rdx, r12
    ...
    0x49, 0x89, 0xf6,                                                                                // mov	r14, rsi
    0x49, 0x89, 0xff,                                                                                // mov	r15, rdi
    0xe8, 0xff, 0xf8, 0xff, 0xff,                                                                    // call	__error
    0x8b, 0x38,                                                                                      // mov	edi, dword ptr [rax]
    0xe8, 0x04, 0xf9, 0xff, 0xff,                                                                    // call	strerror
    ...
    0xe8, 0xc0, 0xf7, 0xff, 0xff,                                                                    // call	fopen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xcb, 0xf7, 0xff, 0xff,                                                                    // call	memset
    0x4c, 0x89, 0xef,                                                                                // mov	rdi, r13
    0xe8, 0xe7, 0xf7, 0xff, 0xff,                                                                    // call	strlen
    ...
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0xf6, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0xe8, 0x32, 0xf7, 0xff, 0xff,                                                                    // call	puts
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    ...
    0xbe, 0x00, 0x04, 0x00, 0x00,                                                                    // mov	esi, 1024
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0xae, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x4d, 0x89, 0xf7,                                                                                // mov	r15, r14
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x54, 0xf7, 0xff, 0xff,                                                                    // call	printf
    ...
    0x41, 0xbf, 0x01, 0x00, 0x00, 0x00,                                                              // mov	r15d, 1
                                                                                                     // L_BB11_12:
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0x0e, 0xf7, 0xff, 0xff,                                                                    // call	fclose
                                                                                                     // L_BB11_13:
    0x44, 0x89, 0xf8,                                                                                // mov	eax, r15d
    ...
    0x48, 0x8d, 0x05, 0x42, 0x06, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.21]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_1:
    ...
    0x48, 0x8d, 0x05, 0x1c, 0x06, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.19]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_10:
    ...
    0x48, 0x8d, 0x05, 0x21, 0x06, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.23]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_2:
    0x48, 0x8d, 0x05, 0xf4, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.17]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_16:
    0x48, 0x8d, 0x05, 0xba, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.15]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_14:
    0x48, 0x8d, 0x05, 0xf2, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.20]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_15:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_13:
    0x48, 0x8d, 0x05, 0xd6, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.18]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // _Z8stringidPKc:
    0x55,                                                                                            // push	rbp
    ...
    0xba, 0x20, 0x00, 0x00, 0x00,                                                                    // mov	edx, 32
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0xe8, 0x62, 0xf6, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    ...
    0x75, 0x18,                                                                                      // jne	L_BB15_2
                                                                                                     // L_BB15_3:
    0x48, 0x8d, 0x3d, 0xa0, 0x05, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.24]
    0x48, 0x8d, 0x75, 0xd0,                                                                          // lea	rsi, [rbp - 48]
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x08, 0xf6, 0xff, 0xff,                                                                    // call	printf
    0xb0, 0x01,                                                                                      // mov	al, 1
    ...
    0xbe, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	esi, 1
    0x31, 0xd2,                                                                                      // xor	edx, edx
    0xe8, 0x07, 0xf6, 0xff, 0xff,                                                                    // call	socket
    0x41, 0x89, 0xc6,                                                                                // mov	r14d, eax
    0x85, 0xc0,                                                                                      // test	eax, eax
    ...
    0xe8, 0xbf, 0xf4, 0xff, 0xff,                                                                    // call	dynlib_get_obj_member
    0x85, 0xc0,                                                                                      // test	eax, eax
    ...
    0xe8, 0xf1, 0xf3, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0xb8, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.38]
    0x89, 0xde,                                                                                      // mov	esi, ebx
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xbb, 0xf3, 0xff, 0xff,                                                                    // call	printf
