...
static const unsigned long __export_onNewProcess_hook_offset = 0x17e;
static const unsigned long __export_PS4_GetAppInfoHook_offset = 0x4cb;
static const unsigned long __export_PS5_GetAppInfoHook_offset = 0x59c;
static const unsigned long __export_PS5_GetAppInfoHook2_offset = 0x61c;
...
static const unsigned char shellcode[] = {
    ...
    0xbe, 0xff, 0xff, 0xff, 0xff,                                                                    // mov	esi, -1
                                                                                                     // L_BB0_3:
    0x48, 0x8d, 0x3d, 0x26, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str]
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x0c, 0xff, 0xff, 0xff,                                                                    // call	printf
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0x4a, 0xfe, 0xff, 0xff,                                                                    // call	onNewProcess_original
    ...
    0x48, 0x8d, 0x3d, 0x28, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.1]
    0xe8, 0x7e, 0xfe, 0xff, 0xff,                                                                    // call	puts
                                                                                                     // L_BB0_6:
    ...
    0x45, 0x31, 0xc0,                                                                                // xor	r8d, r8d
    0x45, 0x31, 0xc9,                                                                                // xor	r9d, r9d
    0xe8, 0x9b, 0xfd, 0xff, 0xff,                                                                    // call	sysctl
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x85, 0x32, 0x02, 0x00, 0x00,                                                              // jne	L_BB1_5
    0x48, 0x8d, 0x3d, 0x0a, 0x10, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str]
    0xe8, 0xcf, 0xfd, 0xff, 0xff,                                                                    // call	puts
    ...
    0xe8, 0xfb, 0x06, 0x00, 0x00,                                                                    // call	_ZL12state_abbrevm
    ...
    0x48, 0x8d, 0x3d, 0x8f, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.14]
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0x41, 0x57,                                                                                      // push	r15
    0x41, 0x56,                                                                                      // push	r14
    0x41, 0x53,                                                                                      // push	r11
    ...
    0x41, 0x55,                                                                                      // push	r13
    0x41, 0x52,                                                                                      // push	r10
    0xe8, 0xa1, 0xfd, 0xff, 0xff,                                                                    // call	printf
    ...
    0xe8, 0x73, 0xfd, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x41, 0x8b, 0x7e, 0x48,                                                                          // mov	edi, dword ptr [r14 + 72]
    0x48, 0x8d, 0xb5, 0x30, 0xff, 0xff, 0xff,                                                        // lea	rsi, [rbp - 208]
    0xe8, 0xaf, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x84, 0x17, 0xff, 0xff, 0xff,                                                              // je	L_BB1_10
    0x48, 0x8d, 0x3d, 0xde, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.13]
    0x89, 0xc6,                                                                                      // mov	esi, eax
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x1b, 0xfd, 0xff, 0xff,                                                                    // call	printf
    ...
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0xe8, 0x3b, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x49, 0x8d, 0xbc, 0x24, 0xbf, 0x01, 0x00, 0x00,                                                  // lea	rdi, [r12 + 447]
    0xe8, 0x2b, 0x06, 0x00, 0x00,                                                                    // call	_Z8stringidPKc
    ...
    0xeb, 0x41,                                                                                      // jmp	L_BB1_19
                                                                                                     // L_BB1_17:
    0x48, 0x8d, 0x3d, 0xa1, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.16]
    0x44, 0x89, 0xf6,                                                                                // mov	esi, r14d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x7b, 0xfc, 0xff, 0xff,                                                                    // call	printf
    ...
    0x48, 0x8d, 0x3d, 0x97, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.17]
    0x44, 0x89, 0xf6,                                                                                // mov	esi, r14d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x54, 0xfc, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0x7d, 0x90,                                                                          // lea	rdi, [rbp - 112]
    0xe8, 0xe5, 0x05, 0x00, 0x00,                                                                    // call	_ZL22send_signal_to_payloadiR11client_data
                                                                                                     // L_BB1_19:
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0xb3, 0xfb, 0xff, 0xff,                                                                    // call	free
    0x31, 0xc0,                                                                                      // xor	eax, eax
                                                                                                     // L_BB1_20:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB1_1:
    0x48, 0x8d, 0x3d, 0xd4, 0x09, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.10]
    0xe8, 0x47, 0xfc, 0xff, 0xff,                                                                    // call	perror
    0xb8, 0x78, 0xff, 0xff, 0xff,                                                                    // mov	eax, -136
    0xeb, 0xdb,                                                                                      // jmp	L_BB1_20
                                                                                                     // L_BB1_3:
    0x48, 0x8d, 0x3d, 0xc8, 0x09, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.11]
    0xe8, 0x34, 0xfc, 0xff, 0xff,                                                                    // call	perror
    0xb8, 0x71, 0xff, 0xff, 0xff,                                                                    // mov	eax, -143
    0xeb, 0xc8,                                                                                      // jmp	L_BB1_20
                                                                                                     // L_BB1_5:
    0x48, 0x8d, 0x3d, 0xae, 0x09, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.10]
    0xe8, 0x21, 0xfc, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0x65, 0xfb, 0xff, 0xff,                                                                    // call	free
    ...
    0x49, 0x89, 0xf6,                                                                                // mov	r14, rsi
    0x49, 0x89, 0xff,                                                                                // mov	r15, rdi
    0x48, 0x8d, 0x3d, 0x33, 0x07, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.2]
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x48, 0x89, 0xd9,                                                                                // mov	rcx, rbx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xc4, 0xfb, 0xff, 0xff,                                                                    // call	printf
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0xfc, 0xfb, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x4d, 0x85, 0xff,                                                                                // test	r15, r15
    0x74, 0x19,                                                                                      // je	L_BB2_3
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    0x74, 0x14,                                                                                      // je	L_BB2_3
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0xba, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edx, 1
    0x89, 0xc3,                                                                                      // mov	ebx, eax
    0xe8, 0x0d, 0x00, 0x00, 0x00,                                                                    // call	_ZL11checkPS4ProPKcP18shellcore_app_infoi
    ...
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // _ZL11checkPS4ProPKcP18shellcore_app_infoi:
    0x55,                                                                                            // push	rbp
    0x48, 0x89, 0xe5,                                                                                // mov	rbp, rsp
    0x41, 0x57,                                                                                      // push	r15
    0x41, 0x56,                                                                                      // push	r14
    ...
    0x49, 0x89, 0xfe,                                                                                // mov	r14, rdi
    0x48, 0x8d, 0x3d, 0x02, 0x0d, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.37]
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0xe8, 0x20, 0x03, 0x00, 0x00,                                                                    // call	match_line_in_file
    0x41, 0x83, 0xff, 0x01,                                                                          // cmp	r15d, 1
    0xb9, 0x9c, 0x01, 0x00, 0x00,                                                                    // mov	ecx, 412
    0x41, 0xbf, 0x6c, 0x02, 0x00, 0x00,                                                              // mov	r15d, 620
    0x4c, 0x0f, 0x44, 0xf9,                                                                          // cmove	r15, rcx
    0x83, 0xf8, 0x01,                                                                                // cmp	eax, 1
    0x75, 0x29,                                                                                      // jne	L_BB3_3
    0xb8, 0x00, 0x00, 0x80, 0x00,                                                                    // mov	eax, 8388608
    0x42, 0x23, 0x04, 0x3b,                                                                          // and	eax, dword ptr [rbx + r15]
    0x74, 0x1e,                                                                                      // je	L_BB3_3
    0x48, 0x8d, 0x15, 0xef, 0x0c, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.40]
    0xbf, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edi, 1
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xd4, 0x01, 0x00, 0x00,                                                                    // call	notify_
    0x42, 0x80, 0x64, 0x3b, 0x02, 0x7f,                                                              // and	byte ptr [rbx + r15 + 2], 127
                                                                                                     // L_BB3_3:
    0x48, 0x83, 0xc4, 0x08,                                                                          // add	rsp, 8
    0x5b,                                                                                            // pop	rbx
    0x41, 0x5e,                                                                                      // pop	r14
    ...
    0x49, 0x89, 0xf6,                                                                                // mov	r14, rsi
    0x49, 0x89, 0xff,                                                                                // mov	r15, rdi
    0x48, 0x8d, 0x3d, 0xef, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.3]
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x48, 0x89, 0xd9,                                                                                // mov	rcx, rbx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xf3, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x2b, 0xfb, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x4d, 0x85, 0xff,                                                                                // test	r15, r15
    0x74, 0x2a,                                                                                      // je	L_BB4_3
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    0x74, 0x25,                                                                                      // je	L_BB4_3
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0xba, 0x02, 0x00, 0x00, 0x00,                                                                    // mov	edx, 2
    0x41, 0x89, 0xc6,                                                                                // mov	r14d, eax
    0xe8, 0x3b, 0xff, 0xff, 0xff,                                                                    // call	_ZL11checkPS4ProPKcP18shellcore_app_infoi
    0x48, 0x81, 0xc3, 0x74, 0x02, 0x00, 0x00,                                                        // add	rbx, 628
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    ...
    0x48, 0x8d, 0x3d, 0xf8, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.4]
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x49, 0x89, 0xd8,                                                                                // mov	r8, rbx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x6c, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x48, 0x89, 0xd9,                                                                                // mov	rcx, rbx
    0xe8, 0xa3, 0xfa, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x4d, 0x85, 0xe4,                                                                                // test	r12, r12
    0x74, 0x2a,                                                                                      // je	L_BB6_3
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    0x74, 0x25,                                                                                      // je	L_BB6_3
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0xba, 0x02, 0x00, 0x00, 0x00,                                                                    // mov	edx, 2
    0x41, 0x89, 0xc6,                                                                                // mov	r14d, eax
    0xe8, 0xb3, 0xfe, 0xff, 0xff,                                                                    // call	_ZL11checkPS4ProPKcP18shellcore_app_infoi
    0x48, 0x81, 0xc3, 0x74, 0x02, 0x00, 0x00,                                                        // add	rbx, 628
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0x86, 0xff, 0xff, 0xff,                                                                    // call	_ZL9enableHFRPKcR10ATTRIBUTE3
    0x44, 0x89, 0xf0,                                                                                // mov	eax, r14d
                                                                                                     // L_BB6_3:
    0x5b,                                                                                            // pop	rbx
    0x41, 0x5c,                                                                                      // pop	r12
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xde, 0xf9, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0xe8, 0x8e, 0xfa, 0xff, 0xff,                                                                    // call	strncpy
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0xd9, 0xf9, 0xff, 0xff,                                                                    // call	strlen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x74, 0x17,                                                                                      // je	L_BB7_3
                                                                                                     // L_BB7_1:
    0x80, 0xbc, 0x05, 0xdc, 0xf3, 0xff, 0xff, 0x0a,                                                  // cmp	byte ptr [rbp + rax - 3108], 10
    0x75, 0x0d,                                                                                      // jne	L_BB7_3
    0xc6, 0x84, 0x05, 0xdc, 0xf3, 0xff, 0xff, 0x00,                                                  // mov	byte ptr [rbp + rax - 3108], 0
    0x48, 0xff, 0xc8,                                                                                // dec	rax
    0x75, 0xe9,                                                                                      // jne	L_BB7_1
                                                                                                     // L_BB7_3:
    0x4d, 0x85, 0xff,                                                                                // test	r15, r15
    0x74, 0x11,                                                                                      // je	L_BB7_4
    0x41, 0x80, 0x3f, 0x00,                                                                          // cmp	byte ptr [r15], 0
    0x48, 0x8d, 0x35, 0xc8, 0x06, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.6]
    0x49, 0x0f, 0x45, 0xf7,                                                                          // cmovne	rsi, r15
    0xeb, 0x07,                                                                                      // jmp	L_BB7_6
                                                                                                     // L_BB7_4:
    0x48, 0x8d, 0x35, 0xbb, 0x06, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.6]
                                                                                                     // L_BB7_6:
    0x48, 0x8d, 0x3d, 0xa5, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.5]
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x83, 0xf9, 0xff, 0xff,                                                                    // call	printf
    0x84, 0xdb,                                                                                      // test	bl, bl
    0x74, 0x15,                                                                                      // je	L_BB7_8
    0x48, 0x8d, 0xb5, 0xb0, 0xf3, 0xff, 0xff,                                                        // lea	rsi, [rbp - 3152]
    0xba, 0x30, 0x0c, 0x00, 0x00,                                                                    // mov	edx, 3120
    0x31, 0xff,                                                                                      // xor	edi, edi
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x82, 0xf9, 0xff, 0xff,                                                                    // call	sceKernelSendNotificationRequest
                                                                                                     // L_BB7_8:
    ...
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xcc, 0xf8, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0xe8, 0xa3, 0xf8, 0xff, 0xff,                                                                    // call	vsnprintf
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    ...
    0x49, 0x89, 0xf6,                                                                                // mov	r14, rsi
    0x49, 0x89, 0xff,                                                                                // mov	r15, rdi
    0xe8, 0x1a, 0xf9, 0xff, 0xff,                                                                    // call	__error
    0x8b, 0x38,                                                                                      // mov	edi, dword ptr [rax]
    0xe8, 0x1f, 0xf9, 0xff, 0xff,                                                                    // call	strerror
    0x48, 0x8d, 0x15, 0x9a, 0x05, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.7]
    0xbf, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edi, 1
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    ...
    0x49, 0x89, 0xfe,                                                                                // mov	r14, rdi
    0x48, 0x8d, 0x35, 0x61, 0x05, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.8]
    0xe8, 0xdb, 0xf7, 0xff, 0xff,                                                                    // call	fopen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x0f, 0x84, 0x9a, 0x00, 0x00, 0x00,                                                              // je	L_BB10_1
    0x48, 0x89, 0xc3,                                                                                // mov	rbx, rax
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xe6, 0xf7, 0xff, 0xff,                                                                    // call	memset
    0x4c, 0x89, 0xef,                                                                                // mov	rdi, r13
    0xe8, 0x02, 0xf8, 0xff, 0xff,                                                                    // call	strlen
    ...
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0x11, 0xf8, 0xff, 0xff,                                                                    // call	fgets
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x74, 0x6f,                                                                                      // je	L_BB10_12
    0x4d, 0x89, 0xf7,                                                                                // mov	r15, r14
    0xeb, 0x03,                                                                                      // jmp	L_BB10_4
                                                                                                     // L_BB10_7:
    0x49, 0xff, 0xc7,                                                                                // inc	r15
                                                                                                     // L_BB10_4:
    0x41, 0x0f, 0xb6, 0x07,                                                                          // movzx	eax, byte ptr [r15]
    0x83, 0xf8, 0x09,                                                                                // cmp	eax, 9
    0x74, 0xf4,                                                                                      // je	L_BB10_7
    0x83, 0xf8, 0x23,                                                                                // cmp	eax, 35
    0x74, 0x1d,                                                                                      // je	L_BB10_10
    0x83, 0xf8, 0x20,                                                                                // cmp	eax, 32
    0x74, 0xea,                                                                                      // je	L_BB10_7
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0xe8, 0x4d, 0xf7, 0xff, 0xff,                                                                    // call	puts
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0xe8, 0x5e, 0x00, 0x00, 0x00,                                                                    // call	_ZL10stringid_lPKcl
    0x44, 0x39, 0xe8,                                                                                // cmp	eax, r13d
    0x74, 0x36,                                                                                      // je	L_BB10_9
                                                                                                     // L_BB10_10:
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xbe, 0x00, 0x04, 0x00, 0x00,                                                                    // mov	esi, 1024
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0xc9, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x4d, 0x89, 0xf7,                                                                                // mov	r15, r14
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x75, 0xbd,                                                                                      // jne	L_BB10_4
    0x45, 0x31, 0xff,                                                                                // xor	r15d, r15d
    0xeb, 0x1f,                                                                                      // jmp	L_BB10_12
                                                                                                     // L_BB10_1:
    0x48, 0x8d, 0x3d, 0xb5, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.9]
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x6f, 0xf7, 0xff, 0xff,                                                                    // call	printf
    0x41, 0xbf, 0xf1, 0xff, 0xff, 0xff,                                                              // mov	r15d, -15
    0xeb, 0x0e,                                                                                      // jmp	L_BB10_13
                                                                                                     // L_BB10_9:
    0x41, 0xbf, 0x01, 0x00, 0x00, 0x00,                                                              // mov	r15d, 1
                                                                                                     // L_BB10_12:
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0x29, 0xf7, 0xff, 0xff,                                                                    // call	fclose
                                                                                                     // L_BB10_13:
    ...
    0x74, 0x29,                                                                                      // je	L_BB11_5
    0x48, 0x85, 0xf6,                                                                                // test	rsi, rsi
    0x74, 0x24,                                                                                      // je	L_BB11_5
    0xba, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edx, 1
                                                                                                     // L_BB11_3:
    ...
    0x7e, 0x1b,                                                                                      // jle	L_BB12_1
    0x48, 0x83, 0xff, 0x05,                                                                          // cmp	rdi, 5
    0x7f, 0x30,                                                                                      // jg	L_BB12_10
    0x48, 0x83, 0xff, 0x04,                                                                          // cmp	rdi, 4
    0x74, 0x51,                                                                                      // je	L_BB12_14
    0x48, 0x83, 0xff, 0x05,                                                                          // cmp	rdi, 5
    0x75, 0x42,                                                                                      // jne	L_BB12_16
    0x48, 0x8d, 0x05, 0x64, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.22]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB12_1:
    0x48, 0x83, 0xff, 0x01,                                                                          // cmp	rdi, 1
    0x74, 0x2a,                                                                                      // je	L_BB12_2
    0x48, 0x83, 0xff, 0x02,                                                                          // cmp	rdi, 2
    0x74, 0x48,                                                                                      // je	L_BB12_13
    0x48, 0x83, 0xff, 0x03,                                                                          // cmp	rdi, 3
    0x75, 0x27,                                                                                      // jne	L_BB12_16
    0x48, 0x8d, 0x05, 0x3e, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.20]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB12_10:
    0x48, 0x83, 0xff, 0x06,                                                                          // cmp	rdi, 6
    0x74, 0x2a,                                                                                      // je	L_BB12_15
    0x48, 0x83, 0xff, 0x07,                                                                          // cmp	rdi, 7
    0x75, 0x12,                                                                                      // jne	L_BB12_16
    0x48, 0x8d, 0x05, 0x43, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.24]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB12_2:
    0x48, 0x8d, 0x05, 0x16, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.18]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB12_16:
    0x48, 0x8d, 0x05, 0xbf, 0x04, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.15]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB12_14:
    0x48, 0x8d, 0x05, 0x14, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.21]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB12_15:
    0x48, 0x8d, 0x05, 0x1a, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.23]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB12_13:
    0x48, 0x8d, 0x05, 0xf8, 0x04, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.19]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // _Z8stringidPKc:
    0x55,                                                                                            // push	rbp
    ...
    0x31, 0xd2,                                                                                      // xor	edx, edx
    0xe8, 0x84, 0xf6, 0xff, 0xff,                                                                    // call	socket
    0x41, 0x89, 0xc6,                                                                                // mov	r14d, eax
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x88, 0x03, 0x01, 0x00, 0x00,                                                              // js	L_BB14_2
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x0f, 0x29, 0x45, 0xc0,                                                                          // movaps	xmmword ptr [rbp - 64], xmm0
    0xc6, 0x45, 0xc1, 0x02,                                                                          // mov	byte ptr [rbp - 63], 2
    0x66, 0xc7, 0x45, 0xc2, 0x5d, 0x6c,                                                              // mov	word ptr [rbp - 62], 27741
    0xbf, 0x02, 0x00, 0x00, 0x00,                                                                    // mov	edi, 2
    0x48, 0x8d, 0x35, 0x13, 0x06, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.30]
    0x48, 0x8d, 0x55, 0xc4,                                                                          // lea	rdx, [rbp - 60]
    0xe8, 0x9b, 0xf6, 0xff, 0xff,                                                                    // call	__inet_pton
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x4c, 0x89, 0xee,                                                                                // mov	rsi, r13
    0xba, 0x10, 0x00, 0x00, 0x00,                                                                    // mov	edx, 16
    0xe8, 0x5b, 0xf6, 0xff, 0xff,                                                                    // call	connect
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x79, 0x63,                                                                                      // jns	L_BB14_4
    0x41, 0x89, 0xc7,                                                                                // mov	r15d, eax
    0x48, 0x8d, 0x3d, 0xf4, 0x05, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.31]
    0xe8, 0x07, 0xf6, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0x2d, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.32]
    0x44, 0x89, 0xfe,                                                                                // mov	esi, r15d
    0x44, 0x89, 0xfa,                                                                                // mov	edx, r15d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xcf, 0xf5, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0x3d, 0x48, 0x08, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str.50]
    0xe8, 0x63, 0xf5, 0xff, 0xff,                                                                    // call	puts
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0x2c, 0xf6, 0xff, 0xff,                                                                    // call	close
    0xbf, 0x40, 0x42, 0x0f, 0x00,                                                                    // mov	edi, 1000000
    0xe8, 0x5d, 0xf5, 0xff, 0xff,                                                                    // call	usleep
    0x49, 0xff, 0xcc,                                                                                // dec	r12
    0x0f, 0x85, 0x60, 0xff, 0xff, 0xff,                                                              // jne	L_BB14_1
    0x8b, 0x0b,                                                                                      // mov	ecx, dword ptr [rbx]
    0x48, 0x8d, 0x15, 0xb8, 0x06, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.36]
    0xbf, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edi, 1
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x37, 0xfc, 0xff, 0xff,                                                                    // call	notify_
    0xeb, 0x57,                                                                                      // jmp	L_BB14_9
                                                                                                     // L_BB14_4:
    0xba, 0x0c, 0x00, 0x00, 0x00,                                                                    // mov	edx, 12
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x06, 0xf6, 0xff, 0xff,                                                                    // call	send
    0xc7, 0x43, 0x08, 0x00, 0x00, 0x00, 0x00,                                                        // mov	dword ptr [rbx + 8], 0
    0xba, 0x0c, 0x00, 0x00, 0x00,                                                                    // mov	edx, 12
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0xe1, 0xf5, 0xff, 0xff,                                                                    // call	recv
    0x8b, 0x5b, 0x08,                                                                                // mov	ebx, dword ptr [rbx + 8]
    0x48, 0x8d, 0x3d, 0x59, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.34]
    0x89, 0xde,                                                                                      // mov	esi, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x51, 0xf5, 0xff, 0xff,                                                                    // call	printf
    0x83, 0xfb, 0x01,                                                                                // cmp	ebx, 1
    0x75, 0x0c,                                                                                      // jne	L_BB14_6
    0x48, 0x8d, 0x3d, 0xa7, 0x07, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str.49]
    0xe8, 0xe0, 0xf4, 0xff, 0xff,                                                                    // call	puts
                                                                                                     // L_BB14_6:
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0xa9, 0xf5, 0xff, 0xff,                                                                    // call	close
                                                                                                     // L_BB14_9:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_2:
    0x48, 0x8d, 0x3d, 0xb4, 0x03, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.25]
    0xe8, 0x41, 0xf5, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0xdc, 0x03, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.26]
    0x44, 0x89, 0xf6,                                                                                // mov	esi, r14d
    0x44, 0x89, 0xf2,                                                                                // mov	edx, r14d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x09, 0xf5, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0x3d, 0x64, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.27]
    0x48, 0x8d, 0x35, 0x64, 0x04, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.28]
    0x48, 0x8d, 0x15, 0x90, 0x04, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.29]
    0xe8, 0x5e, 0xfc, 0xff, 0xff,                                                                    // call	ui_perror_
    0xeb, 0xb5,                                                                                      // jmp	L_BB14_9
                                                                                                     // L_.str:
    ...
    0x70, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x61, 0x70, 0x70, 0x73, 0x28, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x5f, 0x33, 0x29, 0x20, 0x6f, 0x6b, 0x61, 0x79, 0x21, 0x00,  // .asciz	"patch_apps(param_3) okay!"
                                                                                                     // L_.str.2:
    ,  // .asciz	"shellcode/shellcore_attribute.cpp:196 int __cdecl __export_PS4_GetAppInfoHook(const char *, const void *, shellcore_app_info *): (%p,%p,%p)\n"
                                                                                                     // L_.str.3:
    ,  // .asciz	"shellcode/shellcore_attribute.cpp:208 int __cdecl __export_PS5_GetAppInfoHook(const char *, const void *, shellcore_app_info *): (%p,%p,%p)\n"
                                                                                                     // L_.str.4:
    ,  // .asciz	"shellcode/shellcore_attribute.cpp:220 int __cdecl __export_PS5_GetAppInfoHook2(const char *, const void *, const void *, shellcore_app_info *): (%p,%p,%p,%p)\n"
                                                                                                     // L_.str.5:
