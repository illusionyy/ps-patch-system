...
static const unsigned long __export_PS4_GetAppInfoHook_offset = 0x4ea;
static const unsigned long __export_PS5_GetAppInfoHook_offset = 0x5cb;
static const unsigned long __export_PS5_GetAppInfoHook2_offset = 0x653;
...
static const unsigned char shellcode[] = {
    ...
    0xbe, 0xff, 0xff, 0xff, 0xff,                                                                    // mov	esi, -1
                                                                                                     // L_BB0_3:
    0x48, 0x8d, 0x3d, 0x72, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str]
    ...
    0x48, 0x8d, 0x3d, 0x74, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.1]
    ...
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x85, 0x45, 0x02, 0x00, 0x00,                                                              // jne	L_BB1_5
    0x48, 0x8d, 0x3d, 0x1d, 0x12, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str]
    0xe8, 0xc3, 0xfd, 0xff, 0xff,                                                                    // call	puts
    0x48, 0x83, 0x7d, 0xd0, 0x00,                                                                    // cmp	qword ptr [rbp - 48], 0
    0x0f, 0x8e, 0xec, 0x01, 0x00, 0x00,                                                              // jle	L_BB1_18
    0x4c, 0x89, 0xb5, 0x58, 0xff, 0xff, 0xff,                                                        // mov	qword ptr [rbp - 168], r14
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x4c, 0x8d, 0xbd, 0x30, 0xff, 0xff, 0xff,                                                        // lea	r15, [rbp - 208]
    0x49, 0x89, 0xde,                                                                                // mov	r14, rbx
    0xe9, 0xab, 0x00, 0x00, 0x00,                                                                    // jmp	L_BB1_8
                                                                                                     // L_BB1_12:
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    ...
    0x48, 0x8d, 0x3d, 0x79, 0x0c, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.13]
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0x41, 0x57,                                                                                      // push	r15
    0x41, 0x56,                                                                                      // push	r14
    0x41, 0x53,                                                                                      // push	r11
    0x4c, 0x8d, 0x9d, 0x70, 0xff, 0xff, 0xff,                                                        // lea	r11, [rbp - 144]
    0x41, 0x53,                                                                                      // push	r11
    0x41, 0x55,                                                                                      // push	r13
    0x41, 0x52,                                                                                      // push	r10
    0xe8, 0x6b, 0xfd, 0xff, 0xff,                                                                    // call	printf
    ...
    0xe8, 0x40, 0xfd, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x41, 0x8b, 0x7e, 0x48,                                                                          // mov	edi, dword ptr [r14 + 72]
    0x48, 0x8d, 0xb5, 0x60, 0xff, 0xff, 0xff,                                                        // lea	rsi, [rbp - 160]
    0xe8, 0x7c, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x85, 0xf9, 0xfe, 0xff, 0xff,                                                              // jne	L_BB1_12
    0x44, 0x8b, 0xad, 0x60, 0xff, 0xff, 0xff,                                                        // mov	r13d, dword ptr [rbp - 160]
    0xe9, 0x15, 0xff, 0xff, 0xff,                                                                    // jmp	L_BB1_13
                                                                                                     // L_BB1_10:
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x48, 0x8b, 0x85, 0x58, 0xff, 0xff, 0xff,                                                        // mov	rax, qword ptr [rbp - 168]
    0x0f, 0x8e, 0xb0, 0x00, 0x00, 0x00,                                                              // jle	L_BB1_18
    0x44, 0x8b, 0x30,                                                                                // mov	r14d, dword ptr [rax]
    0x4c, 0x8d, 0xbd, 0x60, 0xff, 0xff, 0xff,                                                        // lea	r15, [rbp - 160]
    0x49, 0x89, 0xdc,                                                                                // mov	r12, rbx
    0xeb, 0x13,                                                                                      // jmp	L_BB1_15
                                                                                                     // L_BB1_14:
    0x4d, 0x01, 0xec,                                                                                // add	r12, r13
    0x48, 0x8b, 0x45, 0xd0,                                                                          // mov	rax, qword ptr [rbp - 48]
    0x48, 0x01, 0xd8,                                                                                // add	rax, rbx
    0x49, 0x39, 0xc4,                                                                                // cmp	r12, rax
    0x0f, 0x83, 0x8e, 0x00, 0x00, 0x00,                                                              // jae	L_BB1_18
                                                                                                     // L_BB1_15:
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x0f, 0x29, 0x45, 0xa0,                                                                          // movaps	xmmword ptr [rbp - 96], xmm0
    0x0f, 0x29, 0x45, 0x90,                                                                          // movaps	xmmword ptr [rbp - 112], xmm0
    ...
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0xe8, 0x02, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x49, 0x8d, 0xbc, 0x24, 0xbf, 0x01, 0x00, 0x00,                                                  // lea	rdi, [r12 + 447]
    0xe8, 0x31, 0x06, 0x00, 0x00,                                                                    // call	_Z8stringidPKc
    0x3d, 0xc4, 0xc1, 0xe4, 0xb1,                                                                    // cmp	eax, -1310408252
    0x75, 0xa5,                                                                                      // jne	L_BB1_14
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0x33, 0x06, 0x00, 0x00,                                                                    // call	_ZL15ignore_procnamei
    0x84, 0xc0,                                                                                      // test	al, al
    0x75, 0x99,                                                                                      // jne	L_BB1_14
    0xc7, 0x85, 0x38, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,                                      // mov	dword ptr [rbp - 200], 0
    0x44, 0x89, 0xb5, 0x30, 0xff, 0xff, 0xff,                                                        // mov	dword ptr [rbp - 208], r14d
    0x8b, 0x95, 0x60, 0xff, 0xff, 0xff,                                                              // mov	edx, dword ptr [rbp - 160]
    ...
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x38, 0xfc, 0xff, 0xff,                                                                    // call	printf
    ...
    0xe8, 0x67, 0x06, 0x00, 0x00,                                                                    // call	_ZL22send_signal_to_payloadiR11client_data
                                                                                                     // L_BB1_18:
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0x94, 0xfb, 0xff, 0xff,                                                                    // call	free
    0x31, 0xc0,                                                                                      // xor	eax, eax
                                                                                                     // L_BB1_19:
    ...
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xa5, 0xfb, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0xdd, 0xfb, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xc4, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0xfc, 0xfa, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x35, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0xe8, 0x6c, 0xfa, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0x9f, 0xf9, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0xe8, 0x4f, 0xfa, 0xff, 0xff,                                                                    // call	strncpy
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0x9a, 0xf9, 0xff, 0xff,                                                                    // call	strlen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x44, 0xf9, 0xff, 0xff,                                                                    // call	printf
    ...
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x43, 0xf9, 0xff, 0xff,                                                                    // call	sceKernelSendNotificationRequest
                                                                                                     // L_BB8_8:
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0x8d, 0xf8, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0xe8, 0x64, 0xf8, 0xff, 0xff,                                                                    // call	vsnprintf
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x4c, 0x89, 0xe2,                                                                                // mov	rdx, r12
    ...
    0x49, 0x89, 0xf6,                                                                                // mov	r14, rsi
    0x49, 0x89, 0xff,                                                                                // mov	r15, rdi
    0xe8, 0xdb, 0xf8, 0xff, 0xff,                                                                    // call	__error
    0x8b, 0x38,                                                                                      // mov	edi, dword ptr [rax]
    0xe8, 0xe0, 0xf8, 0xff, 0xff,                                                                    // call	strerror
    ...
    0xe8, 0x9c, 0xf7, 0xff, 0xff,                                                                    // call	fopen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xa7, 0xf7, 0xff, 0xff,                                                                    // call	memset
    0x4c, 0x89, 0xef,                                                                                // mov	rdi, r13
    0xe8, 0xc3, 0xf7, 0xff, 0xff,                                                                    // call	strlen
    ...
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0xd2, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0xe8, 0x0e, 0xf7, 0xff, 0xff,                                                                    // call	puts
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    ...
    0xbe, 0x00, 0x04, 0x00, 0x00,                                                                    // mov	esi, 1024
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0x8a, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x4d, 0x89, 0xf7,                                                                                // mov	r15, r14
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x30, 0xf7, 0xff, 0xff,                                                                    // call	printf
    ...
    0x41, 0xbf, 0x01, 0x00, 0x00, 0x00,                                                              // mov	r15d, 1
                                                                                                     // L_BB11_12:
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0xea, 0xf6, 0xff, 0xff,                                                                    // call	fclose
                                                                                                     // L_BB11_13:
    0x44, 0x89, 0xf8,                                                                                // mov	eax, r15d
    ...
    0x48, 0x8d, 0x05, 0x28, 0x06, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.20]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_1:
    ...
    0x48, 0x8d, 0x05, 0x02, 0x06, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.18]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_10:
    ...
    0x48, 0x8d, 0x05, 0x07, 0x06, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.22]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_2:
    0x48, 0x8d, 0x05, 0xda, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.16]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_16:
    0x48, 0x8d, 0x05, 0xa0, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.14]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_14:
    0x48, 0x8d, 0x05, 0xd8, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.19]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_15:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB13_13:
    0x48, 0x8d, 0x05, 0xbc, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.17]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // _Z8stringidPKc:
    0x55,                                                                                            // push	rbp
    ...
    0xba, 0x20, 0x00, 0x00, 0x00,                                                                    // mov	edx, 32
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0xe8, 0x3e, 0xf6, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0xbe, 0xff, 0xff, 0xff,                                                                    // call	_Z8stringidPKc
    0x3d, 0x42, 0x6c, 0xc7, 0xeb,                                                                    // cmp	eax, -339252158
    0x74, 0x07,                                                                                      // je	L_BB15_3
    0x3d, 0x45, 0x97, 0x63, 0xa0,                                                                    // cmp	eax, -1604085947
    0x75, 0x18,                                                                                      // jne	L_BB15_2
                                                                                                     // L_BB15_3:
    0x48, 0x8d, 0x3d, 0x86, 0x05, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.23]
    0x48, 0x8d, 0x75, 0xd0,                                                                          // lea	rsi, [rbp - 48]
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xe4, 0xf5, 0xff, 0xff,                                                                    // call	printf
    0xb0, 0x01,                                                                                      // mov	al, 1
    0xeb, 0x02,                                                                                      // jmp	L_BB15_4
                                                                                                     // L_BB15_2:
    0x31, 0xc0,                                                                                      // xor	eax, eax
                                                                                                     // L_BB15_4:
    ...
    0xbe, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	esi, 1
    0x31, 0xd2,                                                                                      // xor	edx, edx
    0xe8, 0xe3, 0xf5, 0xff, 0xff,                                                                    // call	socket
    0x41, 0x89, 0xc6,                                                                                // mov	r14d, eax
    0x85, 0xc0,                                                                                      // test	eax, eax
    ...
    0xe8, 0x9b, 0xf4, 0xff, 0xff,                                                                    // call	dynlib_get_obj_member
    0x85, 0xc0,                                                                                      // test	eax, eax
    ...
    0xe8, 0xcd, 0xf3, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0x9e, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.37]
    0x89, 0xde,                                                                                      // mov	esi, ebx
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x97, 0xf3, 0xff, 0xff,                                                                    // call	printf
