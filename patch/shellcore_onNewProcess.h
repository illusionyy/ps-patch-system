...
static const unsigned long __export_PS4_GetAppInfoHook_offset = 0x4e3;
static const unsigned long __export_PS5_GetAppInfoHook_offset = 0x5c4;
static const unsigned long __export_PS5_GetAppInfoHook2_offset = 0x64c;
...
static const unsigned char shellcode[] = {
    ...
    0xbe, 0xff, 0xff, 0xff, 0xff,                                                                    // mov	esi, -1
                                                                                                     // L_BB0_3:
    0x48, 0x8d, 0x3d, 0x6b, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str]
    ...
    0x48, 0x8d, 0x3d, 0x6d, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.1]
    ...
    0x8b, 0x1f,                                                                                      // mov	ebx, dword ptr [rdi]
    0x89, 0xdf,                                                                                      // mov	edi, ebx
    0xe8, 0xd6, 0x07, 0x00, 0x00,                                                                    // call	_ZL15ignore_procnamei
    0x89, 0xc1,                                                                                      // mov	ecx, eax
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0x84, 0xc9,                                                                                      // test	cl, cl
    0x0f, 0x85, 0x72, 0x02, 0x00, 0x00,                                                              // jne	L_BB1_19
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x0f, 0x29, 0x45, 0xb0,                                                                          // movaps	xmmword ptr [rbp - 80], xmm0
    0x48, 0xb8, 0x01, 0x00, 0x00, 0x00, 0x0e, 0x00, 0x00, 0x00,                                      // movabs	rax, 60129542145
    0x48, 0x89, 0x45, 0xb0,                                                                          // mov	qword ptr [rbp - 80], rax
    0xc7, 0x45, 0xb8, 0x08, 0x00, 0x00, 0x00,                                                        // mov	dword ptr [rbp - 72], 8
    0x48, 0xc7, 0x45, 0xd0, 0x00, 0x00, 0x00, 0x00,                                                  // mov	qword ptr [rbp - 48], 0
    0x48, 0x8d, 0x7d, 0xb0,                                                                          // lea	rdi, [rbp - 80]
    0x48, 0x8d, 0x4d, 0xd0,                                                                          // lea	rcx, [rbp - 48]
    0xbe, 0x04, 0x00, 0x00, 0x00,                                                                    // mov	esi, 4
    0x31, 0xd2,                                                                                      // xor	edx, edx
    0x45, 0x31, 0xc0,                                                                                // xor	r8d, r8d
    0x45, 0x31, 0xc9,                                                                                // xor	r9d, r9d
    0xe8, 0xb5, 0xfd, 0xff, 0xff,                                                                    // call	sysctl
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x85, 0x3e, 0x02, 0x00, 0x00,                                                              // jne	L_BB1_2
    0x48, 0x8b, 0x7d, 0xd0,                                                                          // mov	rdi, qword ptr [rbp - 48]
    0xe8, 0xb0, 0xfd, 0xff, 0xff,                                                                    // call	malloc
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x0f, 0x84, 0x3f, 0x02, 0x00, 0x00,                                                              // je	L_BB1_4
    ...
    0x45, 0x31, 0xc0,                                                                                // xor	r8d, r8d
    0x45, 0x31, 0xc9,                                                                                // xor	r9d, r9d
    0xe8, 0x7d, 0xfd, 0xff, 0xff,                                                                    // call	sysctl
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x85, 0x2c, 0x02, 0x00, 0x00,                                                              // jne	L_BB1_6
    0x48, 0x8d, 0x3d, 0x04, 0x12, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str]
    0xe8, 0xb1, 0xfd, 0xff, 0xff,                                                                    // call	puts
    0x48, 0x83, 0x7d, 0xd0, 0x00,                                                                    // cmp	qword ptr [rbp - 48], 0
    0x0f, 0x8e, 0xd3, 0x01, 0x00, 0x00,                                                              // jle	L_BB1_18
    0x89, 0x5d, 0xcc,                                                                                // mov	dword ptr [rbp - 52], ebx
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x4c, 0x8d, 0xbd, 0x30, 0xff, 0xff, 0xff,                                                        // lea	r15, [rbp - 208]
    0x4c, 0x89, 0xf3,                                                                                // mov	rbx, r14
    0xe9, 0xaa, 0x00, 0x00, 0x00,                                                                    // jmp	L_BB1_9
                                                                                                     // L_BB1_13:
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x0f, 0x29, 0x45, 0x90,                                                                          // movaps	xmmword ptr [rbp - 112], xmm0
    0x0f, 0x29, 0x45, 0x80,                                                                          // movaps	xmmword ptr [rbp - 128], xmm0
    ...
    0x48, 0xc7, 0x45, 0xa0, 0x00, 0x00, 0x00, 0x00,                                                  // mov	qword ptr [rbp - 96], 0
    0x45, 0x31, 0xed,                                                                                // xor	r13d, r13d
                                                                                                     // L_BB1_14:
    0x49, 0x01, 0xdc,                                                                                // add	r12, rbx
    0x48, 0x0f, 0xbe, 0xbb, 0x84, 0x01, 0x00, 0x00,                                                  // movsx	rdi, byte ptr [rbx + 388]
    0xe8, 0x47, 0x07, 0x00, 0x00,                                                                    // call	_ZL12state_abbrevm
    0x49, 0x89, 0xc2,                                                                                // mov	r10, rax
    0x8b, 0x73, 0x48,                                                                                // mov	esi, dword ptr [rbx + 72]
    0x8b, 0x53, 0x4c,                                                                                // mov	edx, dword ptr [rbx + 76]
    0x8b, 0x4b, 0x50,                                                                                // mov	ecx, dword ptr [rbx + 80]
    0x44, 0x8b, 0x43, 0x58,                                                                          // mov	r8d, dword ptr [rbx + 88]
    0x48, 0x8b, 0x83, 0x08, 0x01, 0x00, 0x00,                                                        // mov	rax, qword ptr [rbx + 264]
    0x4c, 0x8d, 0x58, 0x3f,                                                                          // lea	r11, [rax + 63]
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x4c, 0x0f, 0x49, 0xd8,                                                                          // cmovns	r11, rax
    0x44, 0x8b, 0x8b, 0xa8, 0x00, 0x00, 0x00,                                                        // mov	r9d, dword ptr [rbx + 168]
    0x49, 0xc1, 0xfb, 0x06,                                                                          // sar	r11, 6
    0x48, 0x8b, 0x9b, 0x00, 0x01, 0x00, 0x00,                                                        // mov	rbx, qword ptr [rbx + 256]
    0x48, 0xc1, 0xeb, 0x14,                                                                          // shr	rbx, 20
    0x48, 0x8d, 0x3d, 0x64, 0x0c, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.13]
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0x41, 0x57,                                                                                      // push	r15
    0x53,                                                                                            // push	rbx
    0x41, 0x53,                                                                                      // push	r11
    0x4c, 0x8d, 0x9d, 0x60, 0xff, 0xff, 0xff,                                                        // lea	r11, [rbp - 160]
    0x41, 0x53,                                                                                      // push	r11
    0x41, 0x55,                                                                                      // push	r13
    0x41, 0x52,                                                                                      // push	r10
    0xe8, 0x5e, 0xfd, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x83, 0xc4, 0x30,                                                                          // add	rsp, 48
    0x48, 0x8b, 0x45, 0xd0,                                                                          // mov	rax, qword ptr [rbp - 48]
    0x49, 0x8d, 0x0c, 0x06,                                                                          // lea	rcx, [r14 + rax]
    0x4c, 0x89, 0xe3,                                                                                // mov	rbx, r12
    0x49, 0x39, 0xcc,                                                                                // cmp	r12, rcx
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x73, 0x69,                                                                                      // jae	L_BB1_11
                                                                                                     // L_BB1_9:
    0x4c, 0x63, 0x23,                                                                                // movsxd	r12, dword ptr [rbx]
    0x0f, 0x29, 0x45, 0x90,                                                                          // movaps	xmmword ptr [rbp - 112], xmm0
    0x0f, 0x29, 0x45, 0x80,                                                                          // movaps	xmmword ptr [rbp - 128], xmm0
    0x0f, 0x29, 0x85, 0x70, 0xff, 0xff, 0xff,                                                        // movaps	xmmword ptr [rbp - 144], xmm0
    0x0f, 0x29, 0x85, 0x60, 0xff, 0xff, 0xff,                                                        // movaps	xmmword ptr [rbp - 160], xmm0
    ...
    0x8b, 0x7b, 0x48,                                                                                // mov	edi, dword ptr [rbx + 72]
    0xba, 0x20, 0x00, 0x00, 0x00,                                                                    // mov	edx, 32
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0xe8, 0x31, 0xfd, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x8b, 0x7b, 0x48,                                                                                // mov	edi, dword ptr [rbx + 72]
    0x48, 0x8d, 0xb5, 0x50, 0xff, 0xff, 0xff,                                                        // lea	rsi, [rbp - 176]
    0xe8, 0x6e, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x85, 0xf9, 0xfe, 0xff, 0xff,                                                              // jne	L_BB1_13
    0x44, 0x8b, 0xad, 0x50, 0xff, 0xff, 0xff,                                                        // mov	r13d, dword ptr [rbp - 176]
    0xe9, 0x18, 0xff, 0xff, 0xff,                                                                    // jmp	L_BB1_14
                                                                                                     // L_BB1_11:
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x44, 0x8b, 0x6d, 0xcc,                                                                          // mov	r13d, dword ptr [rbp - 52]
    0x0f, 0x8e, 0x9e, 0x00, 0x00, 0x00,                                                              // jle	L_BB1_18
    0x4c, 0x8d, 0xbd, 0x50, 0xff, 0xff, 0xff,                                                        // lea	r15, [rbp - 176]
    0x4c, 0x89, 0xf3,                                                                                // mov	rbx, r14
                                                                                                     // L_BB1_16:
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x0f, 0x29, 0x45, 0x90,                                                                          // movaps	xmmword ptr [rbp - 112], xmm0
    ...
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0xe8, 0x0d, 0xfc, 0xff, 0xff,                                                                    // call	sceKernelGetAppInfo
    0x48, 0x8d, 0xbb, 0xbf, 0x01, 0x00, 0x00,                                                        // lea	rdi, [rbx + 447]
    0xe8, 0x98, 0x06, 0x00, 0x00,                                                                    // call	_Z8stringidPKc
    ...
    0x72, 0xa8,                                                                                      // jb	L_BB1_16
    0xeb, 0x3a,                                                                                      // jmp	L_BB1_18
                                                                                                     // L_BB1_17:
    0xc7, 0x85, 0x38, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,                                      // mov	dword ptr [rbp - 200], 0
    0x44, 0x89, 0xad, 0x30, 0xff, 0xff, 0xff,                                                        // mov	dword ptr [rbp - 208], r13d
    0x8b, 0x95, 0x50, 0xff, 0xff, 0xff,                                                              // mov	edx, dword ptr [rbp - 176]
    0x89, 0x95, 0x34, 0xff, 0xff, 0xff,                                                              // mov	dword ptr [rbp - 204], edx
    0x48, 0x8d, 0x3d, 0x7e, 0x0b, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.15]
    0x44, 0x89, 0xee,                                                                                // mov	esi, r13d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x3f, 0xfc, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0xbd, 0x30, 0xff, 0xff, 0xff,                                                        // lea	rdi, [rbp - 208]
    0xe8, 0x67, 0x06, 0x00, 0x00,                                                                    // call	_ZL22send_signal_to_payloadiR11client_data
                                                                                                     // L_BB1_18:
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0x9b, 0xfb, 0xff, 0xff,                                                                    // call	free
    0x31, 0xc0,                                                                                      // xor	eax, eax
                                                                                                     // L_BB1_19:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB1_2:
    0x48, 0x8d, 0x3d, 0xef, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.10]
    0xe8, 0x2f, 0xfc, 0xff, 0xff,                                                                    // call	perror
    0xb8, 0x5b, 0xff, 0xff, 0xff,                                                                    // mov	eax, -165
    0xeb, 0xdb,                                                                                      // jmp	L_BB1_19
                                                                                                     // L_BB1_4:
    0x48, 0x8d, 0x3d, 0xe3, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.11]
    0xe8, 0x1c, 0xfc, 0xff, 0xff,                                                                    // call	perror
    0xb8, 0x54, 0xff, 0xff, 0xff,                                                                    // mov	eax, -172
    0xeb, 0xc8,                                                                                      // jmp	L_BB1_19
                                                                                                     // L_BB1_6:
    0x48, 0x8d, 0x3d, 0xc9, 0x0a, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.10]
    0xe8, 0x09, 0xfc, 0xff, 0xff,                                                                    // call	perror
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0x4d, 0xfb, 0xff, 0xff,                                                                    // call	free
    0xb8, 0x4c, 0xff, 0xff, 0xff,                                                                    // mov	eax, -180
    0xeb, 0xad,                                                                                      // jmp	L_BB1_19
    ...
    0x48, 0x8d, 0x3d, 0x6c, 0x08, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.2]
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xac, 0xfb, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0xe4, 0xfb, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0xeb, 0x08,                                                                                      // jmp	L_BB3_3
                                                                                                     // L_BB3_2:
    0xe8, 0xfa, 0x06, 0x00, 0x00,                                                                    // call	_ZL12get_ps5_attrv
    ...
    0x48, 0x8d, 0x3d, 0xd5, 0x0e, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.38]
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0xe8, 0x13, 0x03, 0x00, 0x00,                                                                    // call	match_line_in_file
    0x83, 0xf8, 0x01,                                                                                // cmp	eax, 1
    0x75, 0x25,                                                                                      // jne	L_BB4_3
    0xb8, 0x00, 0x00, 0x80, 0x00,                                                                    // mov	eax, 8388608
    0x23, 0x03,                                                                                      // and	eax, dword ptr [rbx]
    0x74, 0x1c,                                                                                      // je	L_BB4_3
    0x48, 0x8d, 0x15, 0xd7, 0x0e, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.41]
    0xbf, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edi, 1
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xdc, 0x01, 0x00, 0x00,                                                                    // call	notify_
    ...
    0x49, 0x89, 0xf7,                                                                                // mov	r15, rsi
    0x48, 0x89, 0xfb,                                                                                // mov	rbx, rdi
    0x48, 0x8d, 0x3d, 0x0e, 0x08, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.3]
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xcb, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xfe,                                                                                // mov	rsi, r15
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x03, 0xfb, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    ...
    0xe8, 0x38, 0xff, 0xff, 0xff,                                                                    // call	_ZL14get_attr_fieldmi
    0x49, 0x89, 0xc6,                                                                                // mov	r14, rax
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x48, 0x89, 0xc6,                                                                                // mov	rsi, rax
    0xe8, 0x53, 0xff, 0xff, 0xff,                                                                    // call	_ZL11checkPS4ProPKcR9ATTRIBUTEi
    0x49, 0x83, 0xc6, 0x08,                                                                          // add	r14, 8
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0x0e, 0x00, 0x00, 0x00,                                                                    // call	_ZL9enableHFRPKcR10ATTRIBUTE3
    ...
    0x48, 0x89, 0xfb,                                                                                // mov	rbx, rdi
    0x48, 0x8d, 0x3d, 0x05, 0x08, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.4]
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x4c, 0x89, 0xe2,                                                                                // mov	rdx, r12
    0x4c, 0x89, 0xf9,                                                                                // mov	rcx, r15
    0x4d, 0x89, 0xf0,                                                                                // mov	r8, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x3c, 0xfa, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0x4c, 0x89, 0xf1,                                                                                // mov	rcx, r14
    0xe8, 0x73, 0xfa, 0xff, 0xff,                                                                    // call	__export_GetAppInfoHook
    0x48, 0x85, 0xdb,                                                                                // test	rbx, rbx
    0x74, 0x32,                                                                                      // je	L_BB7_3
    0x4d, 0x85, 0xf6,                                                                                // test	r14, r14
    0x74, 0x2d,                                                                                      // je	L_BB7_3
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xbe, 0x02, 0x00, 0x00, 0x00,                                                                    // mov	esi, 2
    0x41, 0x89, 0xc7,                                                                                // mov	r15d, eax
    0xe8, 0xa8, 0xfe, 0xff, 0xff,                                                                    // call	_ZL14get_attr_fieldmi
    0x49, 0x89, 0xc6,                                                                                // mov	r14, rax
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0x48, 0x89, 0xc6,                                                                                // mov	rsi, rax
    0xe8, 0xc3, 0xfe, 0xff, 0xff,                                                                    // call	_ZL11checkPS4ProPKcR9ATTRIBUTEi
    0x49, 0x83, 0xc6, 0x08,                                                                          // add	r14, 8
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0x7e, 0xff, 0xff, 0xff,                                                                    // call	_ZL9enableHFRPKcR10ATTRIBUTE3
    0x44, 0x89, 0xf8,                                                                                // mov	eax, r15d
                                                                                                     // L_BB7_3:
    0x5b,                                                                                            // pop	rbx
    0x41, 0x5c,                                                                                      // pop	r12
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xa6, 0xf9, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    0xe8, 0x56, 0xfa, 0xff, 0xff,                                                                    // call	strncpy
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0xa1, 0xf9, 0xff, 0xff,                                                                    // call	strlen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x74, 0x17,                                                                                      // je	L_BB8_3
                                                                                                     // L_BB8_1:
    0x80, 0xbc, 0x05, 0xdc, 0xf3, 0xff, 0xff, 0x0a,                                                  // cmp	byte ptr [rbp + rax - 3108], 10
    0x75, 0x0d,                                                                                      // jne	L_BB8_3
    0xc6, 0x84, 0x05, 0xdc, 0xf3, 0xff, 0xff, 0x00,                                                  // mov	byte ptr [rbp + rax - 3108], 0
    0x48, 0xff, 0xc8,                                                                                // dec	rax
    0x75, 0xe9,                                                                                      // jne	L_BB8_1
                                                                                                     // L_BB8_3:
    0x4d, 0x85, 0xff,                                                                                // test	r15, r15
    0x74, 0x11,                                                                                      // je	L_BB8_4
    0x41, 0x80, 0x3f, 0x00,                                                                          // cmp	byte ptr [r15], 0
    0x48, 0x8d, 0x35, 0xc3, 0x07, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.6]
    0x49, 0x0f, 0x45, 0xf7,                                                                          // cmovne	rsi, r15
    0xeb, 0x07,                                                                                      // jmp	L_BB8_6
                                                                                                     // L_BB8_4:
    0x48, 0x8d, 0x35, 0xb6, 0x07, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.6]
                                                                                                     // L_BB8_6:
    0x48, 0x8d, 0x3d, 0xa0, 0x07, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.5]
    0x4c, 0x89, 0xf2,                                                                                // mov	rdx, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x4b, 0xf9, 0xff, 0xff,                                                                    // call	printf
    0x84, 0xdb,                                                                                      // test	bl, bl
    0x74, 0x15,                                                                                      // je	L_BB8_8
    0x48, 0x8d, 0xb5, 0xb0, 0xf3, 0xff, 0xff,                                                        // lea	rsi, [rbp - 3152]
    0xba, 0x30, 0x0c, 0x00, 0x00,                                                                    // mov	edx, 3120
    0x31, 0xff,                                                                                      // xor	edi, edi
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x4a, 0xf9, 0xff, 0xff,                                                                    // call	sceKernelSendNotificationRequest
                                                                                                     // L_BB8_8:
    ...
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0x94, 0xf8, 0xff, 0xff,                                                                    // call	memset
    ...
    0x4c, 0x89, 0xe7,                                                                                // mov	rdi, r12
    0x4c, 0x89, 0xfa,                                                                                // mov	rdx, r15
    0xe8, 0x6b, 0xf8, 0xff, 0xff,                                                                    // call	vsnprintf
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x4c, 0x89, 0xe2,                                                                                // mov	rdx, r12
    0xe8, 0x7e, 0xfe, 0xff, 0xff,                                                                    // call	notify_fixed_
    ...
    0x49, 0x89, 0xf6,                                                                                // mov	r14, rsi
    0x49, 0x89, 0xff,                                                                                // mov	r15, rdi
    0xe8, 0xe2, 0xf8, 0xff, 0xff,                                                                    // call	__error
    0x8b, 0x38,                                                                                      // mov	edi, dword ptr [rax]
    0xe8, 0xe7, 0xf8, 0xff, 0xff,                                                                    // call	strerror
    0x48, 0x8d, 0x15, 0x95, 0x06, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.7]
    0xbf, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edi, 1
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x4c, 0x89, 0xf9,                                                                                // mov	rcx, r15
    ...
    0x41, 0x5f,                                                                                      // pop	r15
    0x5d,                                                                                            // pop	rbp
    0xe9, 0xef, 0xfe, 0xff, 0xff,                                                                    // jmp	notify_
                                                                                                     // match_line_in_file:
    0x55,                                                                                            // push	rbp
    0x48, 0x89, 0xe5,                                                                                // mov	rbp, rsp
    0x41, 0x57,                                                                                      // push	r15
    ...
    0x49, 0x89, 0xfe,                                                                                // mov	r14, rdi
    0x48, 0x8d, 0x35, 0x5c, 0x06, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.8]
    0xe8, 0xa3, 0xf7, 0xff, 0xff,                                                                    // call	fopen
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0xe8, 0xae, 0xf7, 0xff, 0xff,                                                                    // call	memset
    0x4c, 0x89, 0xef,                                                                                // mov	rdi, r13
    0xe8, 0xca, 0xf7, 0xff, 0xff,                                                                    // call	strlen
    ...
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0xd9, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0xe8, 0x15, 0xf7, 0xff, 0xff,                                                                    // call	puts
    0x4c, 0x89, 0xff,                                                                                // mov	rdi, r15
    0x4c, 0x89, 0xe6,                                                                                // mov	rsi, r12
    ...
    0xbe, 0x00, 0x04, 0x00, 0x00,                                                                    // mov	esi, 1024
    0x48, 0x89, 0xda,                                                                                // mov	rdx, rbx
    0xe8, 0x91, 0xf7, 0xff, 0xff,                                                                    // call	fgets
    0x4d, 0x89, 0xf7,                                                                                // mov	r15, r14
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    ...
    0xeb, 0x1f,                                                                                      // jmp	L_BB11_12
                                                                                                     // L_BB11_1:
    0x48, 0x8d, 0x3d, 0xb0, 0x05, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.9]
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x37, 0xf7, 0xff, 0xff,                                                                    // call	printf
    ...
    0x41, 0xbf, 0x01, 0x00, 0x00, 0x00,                                                              // mov	r15d, 1
                                                                                                     // L_BB11_12:
    0x48, 0x89, 0xdf,                                                                                // mov	rdi, rbx
    0xe8, 0xf1, 0xf6, 0xff, 0xff,                                                                    // call	fclose
                                                                                                     // L_BB11_13:
    0x44, 0x89, 0xf8,                                                                                // mov	eax, r15d
    ...
    0x89, 0xfb,                                                                                      // mov	ebx, edi
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    0x0f, 0x29, 0x45, 0xe0,                                                                          // movaps	xmmword ptr [rbp - 32], xmm0
    0x0f, 0x29, 0x45, 0xd0,                                                                          // movaps	xmmword ptr [rbp - 48], xmm0
    0x4c, 0x8d, 0x75, 0xd0,                                                                          // lea	r14, [rbp - 48]
    0xba, 0x20, 0x00, 0x00, 0x00,                                                                    // mov	edx, 32
    0x4c, 0x89, 0xf6,                                                                                // mov	rsi, r14
    0xe8, 0xd8, 0xf6, 0xff, 0xff,                                                                    // call	sceKernelGetProcessName
    0x4c, 0x89, 0xf7,                                                                                // mov	rdi, r14
    0xe8, 0xb3, 0x00, 0x00, 0x00,                                                                    // call	_Z8stringidPKc
    0x3d, 0x42, 0x6c, 0xc7, 0xeb,                                                                    // cmp	eax, -339252158
    0x74, 0x07,                                                                                      // je	L_BB13_3
    0x3d, 0x45, 0x97, 0x63, 0xa0,                                                                    // cmp	eax, -1604085947
    0x75, 0x18,                                                                                      // jne	L_BB13_2
                                                                                                     // L_BB13_3:
    0x48, 0x8d, 0x3d, 0xf0, 0x05, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.16]
    0x48, 0x8d, 0x75, 0xd0,                                                                          // lea	rsi, [rbp - 48]
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x7e, 0xf6, 0xff, 0xff,                                                                    // call	printf
    0xb0, 0x01,                                                                                      // mov	al, 1
    0xeb, 0x02,                                                                                      // jmp	L_BB13_4
                                                                                                     // L_BB13_2:
    0x31, 0xc0,                                                                                      // xor	eax, eax
                                                                                                     // L_BB13_4:
    ...
    0x7e, 0x1b,                                                                                      // jle	L_BB14_1
    0x48, 0x83, 0xff, 0x05,                                                                          // cmp	rdi, 5
    0x7f, 0x30,                                                                                      // jg	L_BB14_10
    0x48, 0x83, 0xff, 0x04,                                                                          // cmp	rdi, 4
    0x74, 0x51,                                                                                      // je	L_BB14_14
    0x48, 0x83, 0xff, 0x05,                                                                          // cmp	rdi, 5
    0x75, 0x42,                                                                                      // jne	L_BB14_16
    0x48, 0x8d, 0x05, 0xde, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.21]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_1:
    0x48, 0x83, 0xff, 0x01,                                                                          // cmp	rdi, 1
    0x74, 0x2a,                                                                                      // je	L_BB14_2
    0x48, 0x83, 0xff, 0x02,                                                                          // cmp	rdi, 2
    0x74, 0x48,                                                                                      // je	L_BB14_13
    0x48, 0x83, 0xff, 0x03,                                                                          // cmp	rdi, 3
    0x75, 0x27,                                                                                      // jne	L_BB14_16
    0x48, 0x8d, 0x05, 0xb8, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.19]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_10:
    0x48, 0x83, 0xff, 0x06,                                                                          // cmp	rdi, 6
    0x74, 0x2a,                                                                                      // je	L_BB14_15
    0x48, 0x83, 0xff, 0x07,                                                                          // cmp	rdi, 7
    0x75, 0x12,                                                                                      // jne	L_BB14_16
    0x48, 0x8d, 0x05, 0xbd, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.23]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_2:
    0x48, 0x8d, 0x05, 0x90, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.17]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_16:
    0x48, 0x8d, 0x05, 0x3e, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.14]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_14:
    0x48, 0x8d, 0x05, 0x8e, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.20]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_15:
    0x48, 0x8d, 0x05, 0x94, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.22]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // L_BB14_13:
    0x48, 0x8d, 0x05, 0x72, 0x05, 0x00, 0x00,                                                        // lea	rax, [rip + L_.str.18]
    0x5d,                                                                                            // pop	rbp
    0xc3,                                                                                            // ret
                                                                                                     // _Z8stringidPKc:
    0x55,                                                                                            // push	rbp
    ...
    0x5d,                                                                                            // pop	rbp
    0xe9, 0xd0, 0xfe, 0xff, 0xff,                                                                    // jmp	_ZL10stringid_lPKcl
                                                                                                     // L_CPI16_0:
    ...
    0xbe, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	esi, 1
    0x31, 0xd2,                                                                                      // xor	edx, edx
    0xe8, 0xea, 0xf5, 0xff, 0xff,                                                                    // call	socket
    0x41, 0x89, 0xc6,                                                                                // mov	r14d, eax
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x0f, 0x88, 0x03, 0x01, 0x00, 0x00,                                                              // js	L_BB16_2
    0x0f, 0x57, 0xc0,                                                                                // xorps	xmm0, xmm0
    ...
    0xbf, 0x02, 0x00, 0x00, 0x00,                                                                    // mov	edi, 2
    0x48, 0x8d, 0x35, 0x8d, 0x06, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.29]
    0x48, 0x8d, 0x55, 0xc4,                                                                          // lea	rdx, [rbp - 60]
    0xe8, 0x01, 0xf6, 0xff, 0xff,                                                                    // call	__inet_pton
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x4c, 0x89, 0xee,                                                                                // mov	rsi, r13
    0xba, 0x10, 0x00, 0x00, 0x00,                                                                    // mov	edx, 16
    0xe8, 0xc1, 0xf5, 0xff, 0xff,                                                                    // call	connect
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x79, 0x63,                                                                                      // jns	L_BB16_4
    0x41, 0x89, 0xc7,                                                                                // mov	r15d, eax
    0x48, 0x8d, 0x3d, 0x6e, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.30]
    0xe8, 0x6d, 0xf5, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0xa7, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.31]
    0x44, 0x89, 0xfe,                                                                                // mov	esi, r15d
    0x44, 0x89, 0xfa,                                                                                // mov	edx, r15d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x35, 0xf5, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0x3d, 0xc6, 0x09, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str.51]
    0xe8, 0xc9, 0xf4, 0xff, 0xff,                                                                    // call	puts
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0x92, 0xf5, 0xff, 0xff,                                                                    // call	close
    0xbf, 0x40, 0x42, 0x0f, 0x00,                                                                    // mov	edi, 1000000
    0xe8, 0xc3, 0xf4, 0xff, 0xff,                                                                    // call	usleep
    0x49, 0xff, 0xcc,                                                                                // dec	r12
    0x0f, 0x85, 0x60, 0xff, 0xff, 0xff,                                                              // jne	L_BB16_1
    0x8b, 0x0b,                                                                                      // mov	ecx, dword ptr [rbx]
    0x48, 0x8d, 0x15, 0x32, 0x07, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.35]
    0xbf, 0x01, 0x00, 0x00, 0x00,                                                                    // mov	edi, 1
    0x31, 0xf6,                                                                                      // xor	esi, esi
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xd5, 0xfb, 0xff, 0xff,                                                                    // call	notify_
    0xeb, 0x57,                                                                                      // jmp	L_BB16_9
                                                                                                     // L_BB16_4:
    0xba, 0x0c, 0x00, 0x00, 0x00,                                                                    // mov	edx, 12
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x6c, 0xf5, 0xff, 0xff,                                                                    // call	send
    0xc7, 0x43, 0x08, 0x00, 0x00, 0x00, 0x00,                                                        // mov	dword ptr [rbx + 8], 0
    0xba, 0x0c, 0x00, 0x00, 0x00,                                                                    // mov	edx, 12
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0x48, 0x89, 0xde,                                                                                // mov	rsi, rbx
    0x31, 0xc9,                                                                                      // xor	ecx, ecx
    0xe8, 0x47, 0xf5, 0xff, 0xff,                                                                    // call	recv
    0x8b, 0x5b, 0x08,                                                                                // mov	ebx, dword ptr [rbx + 8]
    0x48, 0x8d, 0x3d, 0xd3, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.33]
    0x89, 0xde,                                                                                      // mov	esi, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0xb7, 0xf4, 0xff, 0xff,                                                                    // call	printf
    0x83, 0xfb, 0x01,                                                                                // cmp	ebx, 1
    0x75, 0x0c,                                                                                      // jne	L_BB16_6
    0x48, 0x8d, 0x3d, 0x25, 0x09, 0x00, 0x00,                                                        // lea	rdi, [rip + L_str.50]
    0xe8, 0x46, 0xf4, 0xff, 0xff,                                                                    // call	puts
                                                                                                     // L_BB16_6:
    0x44, 0x89, 0xf7,                                                                                // mov	edi, r14d
    0xe8, 0x0f, 0xf5, 0xff, 0xff,                                                                    // call	close
                                                                                                     // L_BB16_9:
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB16_2:
    0x48, 0x8d, 0x3d, 0x2e, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.24]
    0xe8, 0xa7, 0xf4, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0x56, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.25]
    0x44, 0x89, 0xf6,                                                                                // mov	esi, r14d
    0x44, 0x89, 0xf2,                                                                                // mov	edx, r14d
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x6f, 0xf4, 0xff, 0xff,                                                                    // call	printf
    0x48, 0x8d, 0x3d, 0xde, 0x04, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.26]
    0x48, 0x8d, 0x35, 0xde, 0x04, 0x00, 0x00,                                                        // lea	rsi, [rip + L_.str.27]
    0x48, 0x8d, 0x15, 0x0a, 0x05, 0x00, 0x00,                                                        // lea	rdx, [rip + L_.str.28]
    0xe8, 0xfc, 0xfb, 0xff, 0xff,                                                                    // call	ui_perror_
    0xeb, 0xb5,                                                                                      // jmp	L_BB16_9
                                                                                                     // _ZL12get_ps5_attrv:
    0x55,                                                                                            // push	rbp
    0x48, 0x89, 0xe5,                                                                                // mov	rbp, rsp
    ...
    0x8b, 0x05, 0xad, 0x06, 0x00, 0x00,                                                              // mov	eax, dword ptr [rip + _ZZL30get_firmware_version_from_diskiRjE6cached]
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x74, 0x03,                                                                                      // je	L_BB19_1
    ...
    0xe8, 0xa2, 0xf4, 0xff, 0xff,                                                                    // call	dynlib_get_obj_member
    0x85, 0xc0,                                                                                      // test	eax, eax
    0x75, 0x1b,                                                                                      // jne	L_BB19_2
    0x48, 0x8b, 0x45, 0xf0,                                                                          // mov	rax, qword ptr [rbp - 16]
    0x48, 0x85, 0xc0,                                                                                // test	rax, rax
    0x74, 0x0b,                                                                                      // je	L_BB19_5
    0x8b, 0x40, 0x14,                                                                                // mov	eax, dword ptr [rax + 20]
    0x89, 0x05, 0x6c, 0x06, 0x00, 0x00,                                                              // mov	dword ptr [rip + _ZZL30get_firmware_version_from_diskiRjE6cached], eax
    ...
    0xc3,                                                                                            // ret
                                                                                                     // L_BB19_2:
    0x48, 0x8d, 0x3d, 0x60, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.36]
    0x89, 0xc3,                                                                                      // mov	ebx, eax
    0xe8, 0xd4, 0xf3, 0xff, 0xff,                                                                    // call	perror
    0x48, 0x8d, 0x3d, 0x9e, 0x06, 0x00, 0x00,                                                        // lea	rdi, [rip + L_.str.37]
    0x89, 0xde,                                                                                      // mov	esi, ebx
    0x89, 0xda,                                                                                      // mov	edx, ebx
    0x31, 0xc0,                                                                                      // xor	eax, eax
    0xe8, 0x9e, 0xf3, 0xff, 0xff,                                                                    // call	printf
    0xeb, 0xd7,                                                                                      // jmp	L_BB19_5
                                                                                                     // L_.str:
    ...
    0x73, 0x68, 0x65, 0x6c, 0x6c, 0x63, 0x6f, 0x72, 0x65, 0x20, 0x73, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x20, 0x74, 0x6f, 0x20, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x3a, 0x20, 0x70, 0x69, 0x64, 0x20, 0x25, 0x64, 0x20, 0x61, 0x70, 0x70, 0x69, 0x64, 0x20, 0x30, 0x78, 0x25, 0x78, 0x0a, 0x00,  // .asciz	"shellcore sending to server: pid %d appid 0x%x\n"
                                                                                                     // L_.str.16:
    0x69, 0x67, 0x6e, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x20, 0x25, 0x73, 0x20, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x20, 0x25, 0x64, 0x0a, 0x00,  // .asciz	"ignoring %s process %d\n"
                                                                                                     // L_.str.17:
